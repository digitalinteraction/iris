...
const char * const classifier_names[] = {"CARROT", "PEACH", "APPLE", "MANDARIN", "ONION"};
...
timespec Low_Res_Worker::diff(timespec start, timespec end)
{
	timespec temp;
...
#ifdef COLOR
            Mat send_img;
            cvtColor(img, send_img, COLOR_RGBA2RGB);
