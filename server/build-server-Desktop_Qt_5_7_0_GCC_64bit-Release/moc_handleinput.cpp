...
QT_MOC_LITERAL(5, 28, 3) // "mac"
    ...
    "HandleInput\0MACChanged\0\0x\0y\0mac"
};
...
void HandleInput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->MACChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
        ...
        {
            typedef void (HandleInput::*_t)(int , int , int );
...
const QMetaObject HandleInput::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HandleInput.data,
...
// SIGNAL 0
void HandleInput::MACChanged(int _t1, int _t2, int _t3)
{
