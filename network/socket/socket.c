...
int send_data_raw(int sockfd, unsigned char buffer[], unsigned int buffer_length, struct sockaddr_in *addr,
...
int recv_data_raw(int sockfd, unsigned char buffer[], int *recv_len, unsigned int buffer_length,
